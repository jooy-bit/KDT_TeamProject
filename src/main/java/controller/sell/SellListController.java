...
import dao.SellLsitDao;
import dto.Paging;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class SellListController implements Controller {
	private static final Logger logger = LoggerFactory.getLogger(SellListController.class);
	...
	public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SellLsitDao dao = SellLsitDao.getInstance();
		...
		if(category!=null) {   //새로운 검색값으로 검색 버튼을 클릭했을 때
